...
class MainMenu:
    ...
    def custom_game(self):
        ...
        start_btn.bind("<Enter>", lambda e: start_btn.config(bg=self.COLORS['button_hover'], fg=self.COLORS['bg']))
        start_btn.bind("<Leave>", lambda e: start_btn.config(bg=self.COLORS['success'], fg='white'))
    ...
    def view_highscores(self):
        ...
        close_btn.bind("<Enter>", lambda e: close_btn.config(bg=self.COLORS['button_hover'], fg=self.COLORS['bg']))
    ...
    def generate_analytics(self):
        ...
        generate_btn.bind("<Enter>", lambda e: generate_btn.config(bg=self.COLORS['button_hover'], fg=self.COLORS['bg']))
        generate_btn.bind("<Leave>", lambda e: generate_btn.config(bg=self.COLORS['success'], fg='white'))
